...
Partial Class MDIPrincipal
    ...
    Private Sub InitializeComponent()
        ...
        Button11.Image = My.Resources.Resources.logout
        ...
        ' PanelFinanzas
        ' 
        PanelFinanzas.Controls.Add(btnEgresos)
        PanelFinanzas.Controls.Add(BtnIngresos)
        PanelFinanzas.Dock = DockStyle.Top
        PanelFinanzas.Location = New Point(0, 404)
        PanelFinanzas.Name = "PanelFinanzas"
        PanelFinanzas.Size = New Size(191, 62)
        PanelFinanzas.TabIndex = 14
        ' 
        ' btnEgresos
        ' 
        btnEgresos.BackColor = Color.FromArgb(CByte(35), CByte(32), CByte(39))
        btnEgresos.Dock = DockStyle.Top
        btnEgresos.FlatAppearance.BorderSize = 0
        btnEgresos.FlatStyle = FlatStyle.Flat
        btnEgresos.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold)
        btnEgresos.ForeColor = SystemColors.Control
        btnEgresos.Location = New Point(0, 30)
        btnEgresos.Name = "btnEgresos"
        btnEgresos.Padding = New Padding(30, 0, 0, 0)
        btnEgresos.Size = New Size(191, 30)
        btnEgresos.TabIndex = 2
        ...
        ' BtnIngresos
        ' 
        BtnIngresos.BackColor = Color.FromArgb(CByte(35), CByte(32), CByte(39))
        BtnIngresos.Dock = DockStyle.Top
        BtnIngresos.FlatAppearance.BorderSize = 0
        BtnIngresos.FlatStyle = FlatStyle.Flat
        BtnIngresos.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold)
        BtnIngresos.ForeColor = SystemColors.Control
        BtnIngresos.Location = New Point(0, 0)
        BtnIngresos.Name = "BtnIngresos"
        BtnIngresos.Padding = New Padding(30, 0, 0, 0)
        BtnIngresos.Size = New Size(191, 30)
	...
	Friend WithEvents PanelFinanzas As Panel
	Friend WithEvents btnEgresos As Button
